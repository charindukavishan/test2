...
@Component({
  selector: 'app-weel',
  templateUrl: './weel.component.html',
  styleUrls: ['./weel.component.scss']
})
export class WeelComponent implements OnInit {
  ...
  constructor(private flashMessage:FlashMessagesService,private modalService: NgbModal,private service:RegserviceService ,private router: Router) {}
    ...
    ngOnInit() {
      ...
      this.service.getKeeperProfile().subscribe(profile =>{
        ...
        this.amounts=this.user.alocatedSlots4;
        this.num= this.user.alocatedSlots14;
        this.charge=this.user.hourCharge4;
        this.Arr=this.user.type4;
